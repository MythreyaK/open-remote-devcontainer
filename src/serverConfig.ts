// Based off of https://github.com/jeanp413/open-remote-ssh, MIT
...
export async function getVSCodeServerConfig(): Promise<IServerConfig> {
    ...
    // const customServerBinaryName = vscode.workspace.getConfiguration('remote.devcontainer').get<string>('serverBinaryName', '');
    // const serverValidation = vscode.workspace.getConfiguration('remote.devcontainer').get<ServerValidation>('serverValidation', 'strict');
